...
urlpatterns = [
    ...
    path('close-payment/', close_payment, name="close_payment"),
    path('purchase/<int:order_id>/', purchase, name="purchase"),
    path('add-cart/<int:item_id>/', add_cart, name="add_cart" ),
    path('remove-cart/<int:item_id>/', remove_cart, name="remove_cart" ),
    path('add-address/', add_address, name="add_address"),
    path('finished-order/', finished_order, name="finished_order"),
